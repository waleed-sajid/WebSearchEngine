...
public class Cache {
	...
	public static Boolean existsInCache(String path) {
		...
		try {
			...
			while (line != null) {
				...
				// Split the name from cache and take out the uri which will be first sequence
				// before space as per our naming convention
	...
	public static void deleteCache() {
		try {
			...
			Utilities.log("Cache has been cleared");
